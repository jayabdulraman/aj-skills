...
Generate each image separately. Replace variables with content from the writing. Do not combine multiple images into one collage.
...
Structure type:
{structure type: Workflow / System Slice / Before-After Contrast / Character State / Concept Metaphor / Method Layers / Map Route / Mini Comic}

Core idea:
{the core idea this image should express}

Composition:
{specific scene: where Xiaohei is, what Xiaohei is doing, main objects, and how information or movement flows}
...
Make Xiaohei more central and strange:
